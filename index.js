...
let buttons = [
{buttonId: `wkwwk`, buttonText: {displayText: 'sᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ 💐'}, type: 1}
]
let buttonMessage = {
...
title: `${ownername}`,
body: `ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ʙᴀᴄᴀ ᴅᴇsᴋʀɪᴘsɪ ɢʀᴜᴘ`,
mediaType:2,
thumbnail: buffer,
sourceUrl: `${websitex}`,
mediaUrl: `${websitex}`
...
└┬❖ 「 @${xeonName.split("@")[0]}  」
   ...
   //you fail to put, i sue you for sure!
let buttons = [
{buttonId: `wkwkwk`, buttonText: {displayText: 'sᴇʟᴀᴍᴀᴛ ᴛɪɴɢɢᴀʟ 🥀'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./XeonMedia/theme/cheems.xlsx'),
mimetype: docs,
...
contextInfo:{externalAdReply:{
title: `${ownername}`,
body: `sᴇʟᴀᴍᴀᴛ ᴛɪɴɢɢᴀʟ sᴇᴍᴏɢᴀ ᴅɪ ᴛᴇʀɪᴍᴀ ᴅɪ sɪsɪɴʏᴀ 🤗.`,
mediaType:2,
thumbnail: buffer,
sourceUrl: `${websitex}`,
mediaUrl: `${websitex}`
