...
reply(`
ᴊᴀɴɢᴀɴ ᴛᴀɢ !
ᴅɪᴀ sᴇᴅᴀɴɢ ᴀғᴋ : ${reason ? 'with reason ' + reason : 'no reason'}
...
let user = global.db.users[m.sender]
reply(`
ᴅɪᴀ sᴇᴅᴀɴɢ ᴀғᴋ / ᴏғғʟɪɴᴇ ${user.afkReason ? ' after ' + user.afkReason : ''}
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./XeonMedia/theme/cheemspic.jpg'), `${watermark}`, `${botname}`, "6282252285143@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
reply(`\`\`\`「 ɢʀᴜᴘ ʟɪɴᴋ ᴅᴇᴛᴇᴄᴛ」\`\`\`\n\nᴛɪᴅᴀᴋ ᴀᴋᴀɴ ᴅɪ ᴋɪᴄᴋ ᴋᴀʀᴇɴᴀ ʏᴀɴɢ ᴅɪ ᴋɪʀɪᴍ ʟɪɴᴋ ɢʀᴜᴘ ɪɴɪ`)
} else if (isUrl(m.text)) {
bvl = `\`\`\`「 ɢʀᴜᴘ ʟɪɴᴋ ᴅᴇᴛᴇᴄᴛ 」\`\`\`\n\nᴀᴅᴍɪɴ ᴍᴇɴɢɪʀɪᴍ ʟɪɴᴋ,ᴀᴅᴍɪɴ ʙᴇʙᴀs ᴍᴇɴɢɪʀɪᴍ ʟɪɴᴋ ᴀᴘᴀᴘᴜɴ`
...
tos = ['ᴊᴀɴɢᴀɴ ᴛᴏxɪᴄ, watch your mouth','Never been taught how to speak?','Stop being toxic my friend','Dont be toxic']
sin =  tos[Math.floor(Math.random() * (tos.length))]
reply(sin)
if (m.text) {
bvl = `\`\`\`「 ʙᴀᴅ ᴡᴏʀᴅ ᴅᴇᴛᴇᴄᴛ 」\`\`\`\n\nᴋᴀʀᴇɴᴀ ᴀᴅᴍɪɴ ʏɢ ᴍᴇɴɢᴜᴄᴀᴘᴋᴀɴ ᴋᴀᴛᴀ ᴋᴀsᴀʀ,ᴛɪᴅᴀᴋ ᴀᴋᴀɴ ᴅɪ ᴋɪᴄᴋ`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
await XeonBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove')
XeonBotInc.sendMessage(from, {text:`\`\`\`「 ʙᴀᴅ ᴡᴏʀᴅ ᴅᴇᴛᴇᴄᴛ 」\`\`\`\n\n@${kice.split("@")[0]} ᴀᴋᴀɴ ᴅɪ ᴋɪᴄᴋ ᴋᴀʀᴇɴᴀ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ᴋᴀᴛᴀ ᴋᴀsᴀʀ`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})}
}
// AntiLink gc by xeon
if (AntiLink) {
if (!isBotAdmins) return
linkgce = await XeonBotInc.groupInviteCode(from)
if (budy.includes(`https://chat.whatsapp.com/${linkgce}`)) {
reply(`\`\`\`「 ʟɪɴᴋ ɢʀᴜᴘ ᴅᴇᴛᴇᴄᴛ 」\`\`\`\n\nᴛɪᴅᴀᴋ ᴀᴋᴀɴ ᴅɪ ᴋɪᴄᴋ ᴋᴀʀᴇɴᴀ ɪᴛᴜ ᴀᴅᴀʟᴀʜ ʟɪɴᴋ ɢʀᴜᴘ ɪɴɪ`)
} else if (isUrl(m.text)) {
bvl = `\`\`\`「 ʟɪɴᴋ ɢʀᴜᴘ ᴅᴇᴛᴇᴄᴛ 」\`\`\`\n\nᴀᴅᴍɪɴ ᴍᴇɴɢɪʀɪᴍ ʟɪɴᴋ,ᴀᴅᴍɪɴ ʙᴇʙᴀs ᴍᴇɴɢɪʀɪᴍ ʟɪɴᴋ ᴀᴘᴀᴘᴜɴ`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
if (!isBotAdmins) return
bvl = `\`\`\`「 ɪɴsᴛᴀɢʀᴀᴍ ʟɪɴᴋ ᴅᴇᴛᴇᴄᴛ 」\`\`\`\n\nᴀᴅᴍɪɴ ᴍᴇɴɢɪʀɪᴍ ʟɪɴᴋ ɪɢ,ᴀᴅᴍɪɴ ʙᴇʙᴀs ᴍᴇɴɢɪʀɪᴍ ʟɪɴᴋ ᴀᴘᴀᴘᴜɴ`
if (isAdmins) return reply(bvl)
if (m.key.fromMe) return reply(bvl)
if (isCreator) return reply(bvl)
kice = m.sender
...
${themeemoji} Clock : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')} 
${themeemoji} Date : ${moment.tz('Asia/Jakarta').format('DD/MM/YYYY')}
${themeemoji} MessageType : ${m.mtype}`
XeonBotInc.sendTextWithMentions(m.chat, teks, m)
await sleep(500)
m.copyNForward(m.chat, true, { readViewOnce: true }).catch(_ => reply(`ᴍᴜɴɢᴋɪɴ ᴛᴇʟᴀʜ ᴅɪ ʙᴜᴋᴀ ᴏʟᴇʜ ʙᴏᴛ`))
}
...
if (!roof.pilih && !roof.pilih2) XeonBotInc.sendText(m.chat, `kedua pemain tidak memilih\nSuit Di Batalkan`)
...
//FAKE CONTACT
const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `6282252285143 -1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Click to chat\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
//FAKEREPLY PRODUCT
const ftoko = {
key: {
fromMe: false,
...
//fake gif by xeon
	 ...
	 { remoteJid: "6282252285143-1613049930@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
                 "title": `ʏᴀɴɴ`,
...
"message": {
"groupInviteMessage": {
"groupJid": "6282252285143-1616169743@g.us",
...
│「 Hi 👋 」
└┬❖ 「 ${pushname} 」
┌┤❖  sᴇʟᴀᴍᴀᴛ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ʙᴏᴛ
│└────────────┈❖
│
└─「 ɪɴғᴏ ʙᴏᴛ 」       
│sᴘᴇᴇᴅ 🚀 : ${latensie.toFixed(4)} miliseconds
│ʀᴜɴᴛɪᴍᴇ ⏱️ : ${runtime(process.uptime())}
│ɴᴀᴍᴀ ʙᴏᴛ 🤖 : ${global.botname}
│ɴᴀᴍᴀ ᴏᴡɴᴇʀ 👤: ${global.ownername}
│ᴏᴡɴᴇʀ ɴᴏ. 📨 : ${global.ownernummenu}
│ʜᴏsᴛ ɴᴀᴍᴇ 📱 : ${os.hostname()}
│ᴘʟᴀᴛғʀᴏᴍ 📱 : ${os.platform()}
│ᴊᴜᴍʟᴀʜ ᴜsᴇʀ 🗂️ : ${Object.keys(global.db.users).length}
│ᴛᴏᴛᴀʟ ᴄᴏᴍᴍᴀɴᴅ 📂 : ${jumlahcmd}
...
│ɢᴏʟᴅ : ${getEmas(m.sender)}
│ᴇᴍᴇʀᴀʟᴅ : ${getEmerald(m.sender)}
│ᴘᴏᴛɪᴏɴ : ${getPotion(m.sender)}
└┬────────────┈ ❖
   │✑  sɪʟᴀʜᴋᴀɴ ᴘɪʟɪʜ
   │✑  sᴀʟᴀʜ sᴀᴛᴜ ʙᴜᴛᴛᴏɴ ᴅɪ ʙᴀᴡᴀʜ
   └─────────────┈❖`
...
case 'sc': case 'script': case 'donate': case 'donate': case 'cekupdate': case 'updatebot': case 'cekbot': case 'sourcecode': {
	if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
teks = `*「 ${global.botname} sᴄʀɪᴘᴛ 」*\n\nᴡᴇʙsɪᴛᴇ: ${global.websitex}\nGitHub: ${global.botscript}\n\nᴛᴇᴋᴀɴ ʟɪɴᴋ ᴅɪ ᴀᴛᴀs ᴜɴᴛᴜᴋ ᴅᴏɴᴀsɪ`
let buttons = [
...
title:"sᴄ ᴏʀɪ xᴇᴏɴ - ɢᴡ ᴄᴜᴍᴀɴ ɢᴀɴᴛɪ ᴊᴀᴅɪ ʙ ɪɴᴅᴏ ᴀᴊᴀ",
body: "ᴋʟɪᴋ ᴅɪsɪɴɪ ᴜɴᴛᴜᴋ ᴅᴏɴᴀsɪ", 
thumbnail: fs.readFileSync("XeonMedia/theme/cheemspic.jpg"),
mediaType:1,
mediaUrl: 'https://telegra.ph/file/0736be30b35af1d908598.jpg',
sourceUrl: "https://telegra.ph/file/0736be30b35af1d908598.jpg"
}}
}
...
if (args[0] === "on") {
if (isBanChat) return replay('sᴜᴄᴄᴇs ʙᴀɴɴᴇᴅ')
banchat.push(from)
replay('sᴜᴄᴄᴇss ʙᴀɴ ʙᴏᴛ ᴅɪ ɢᴄ ɪɴɪ')
...
if (isBanChat) return reply(mess.banChat)
     ...
     console.log(anui)
    XeonBotInc.sendMessage(from, {image:{url:anui}, caption:"✔︎"}, {quoted:m})
}
   break
  case 'whitebear':{
  	if (isBan) return reply(mess.ban)	 			
...
console.log(anu)
XeonBotInc.sendMessage(from,{image:{url:anu}, caption:"✔︎"},{quoted:m})
}
break
case 'retro':{
	if (isBan) return reply(mess.ban)	 			
...
XeonBotInc.sendMessage(from, {image:{url:teds}, caption:"✔︎"}, {quoted:m})
} else if (args[0] === 'glow') {
if (args.length < 2) return reply(`Example :\n${prefix + command + ' ' + args[0]} ${ownername}`)
...
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./XeonMedia/theme/cheemsthumb.jpg'), `${global.watermark}`, `${global.botname}`, "6282252285143@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await XeonBotInc.groupAcceptInvite(vcc).then(async(res) => replay(jsonformat(res))).catch(_ => _)
replay("Succes!")
} else {
...
break
 ...
 reply(mess.error) 
   ...
   const xeonytiktoknowm = musim_rambutan.result.nowatermark
    XeonBotInc.sendMessage(from, { video: { url: xeonytiktoknowm }, caption: "✔︎" }, { quoted: m })
   }
  break
  case 'tiktokaudio':
case 'tiktokmusic':
...
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                XeonBotInc.sendMessage(m.chat, { video: { url: media.dl_link }, jpegThumbnail:buf, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `✔︎` }, { quoted: m }).catch((err) => reply(mess.error))
            }
            break
            case 'ytdl': {
            	if (isBan) return reply(mess.ban)
...
XeonBotInc.sendMessage(from, {image:{url:buffer}, caption:"✔︎"}, {quoted:m})
break
case 'ytmp32':
  case 'youtubemp32':{
  	if (isBan) return reply(mess.ban)
...
XeonBotInc.sendMessage(from, {image:{url:nye}, caption:"✔︎"}, {quoted:m})
break			
case 'xxxanjing':
if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
reply(mess.wait)						
 waifudd = await axios.get(`https://nekos.life/api/v2/img/${command}`)
                           var wbuttsss = [
        {buttonId: `.${command}`, buttonText: {displayText: `sᴇʟᴀɴᴊᴜᴛɴʏᴀ 🔥`}, type: 1},
        ]
...
reply(mess.wait)						
   waifud = await axios.get('https://waifu.pics/api/sfw/neko')
                var wbutsss = [
        {buttonId: `.neko`, buttonText: {displayText: `sᴇʟᴀɴᴊᴜᴛɴʏᴀ 🔥`}, type: 1},
        ]
      let buttonssMessage = {
...
var wbutsss = [
    {buttonId: `.shinobu`, buttonText: {displayText: `sᴇʟᴀɴᴊᴜᴛɴʏᴀ 🔥`}, type: 1},
         ]
...
var wbutsss = [
    {buttonId: `.megumin`, buttonText: {displayText: `sᴇʟᴀɴᴊᴜᴛɴʏᴀ 🔥`}, type: 1},
         ]
      let buttonzMessage = {
      image: {url:ud.data.url},
       caption:  `✔︎`,
...
var walb = [
        {buttonId: `.${command} ${q}`, buttonText: {displayText: `sᴇʟᴀɴᴊᴜᴛɴʏᴀ 🔥`}, type: 1},        
        ]
      let wal = {
...
Available Formats: pdf, docx, pptx, xlsx`)
		...
		break
		    case 'nomerhoki': case 'nomorhoki': {
			   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                if (!Number(text)) return reply(`Example : ${prefix + command} 6282252285143`)
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    ...
                    sections: [{
								"title": "ғɪᴛᴜʀ ᴀᴡᴀʟ ʙᴏᴛ ",
								"rows": [
									{
										"title": "ᴏᴛʜᴇʀ ☕",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴅᴀғᴛᴀʀ ғɪᴛᴜʀ ᴏᴛʜᴇʀ/ʟᴀɪɴɴʏᴀ",
							...
							},
							{
								...
								"rows": [
									{
										"title": "ᴀʟʟ ᴍᴇɴᴜ 🗂️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ sᴇᴍᴜᴀ ᴍᴇɴᴜ ʙᴏᴛ",
										"rowId": `${prefix}allmenu`
									},
									{
										"title": "ᴏᴡɴᴇʀ ᴍᴇɴᴜ 👤",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ғɪᴛᴜʀ ᴋʜᴜsᴜs ᴏᴡɴᴇʀ",
										"rowId": `${prefix}ownermenu`
										},
									{
										"title": "ɢʀᴜᴘ ᴍᴇɴᴜ👥",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ғɪᴛᴜʀ ɢʀᴜᴘ",
										"rowId": `${prefix}groupmenu`
										},
										{
										"title": "ʀᴘɢ ᴍᴇɴᴜ 🏞️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀᴍ ᴍᴇɴᴜ ʀᴘɢ",
										"rowId": `${prefix}rpgmenu`
										},
										{
										"title": "ᴍᴀᴋᴇʀ ᴍᴇɴᴜ🛠️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴍᴀᴋᴇʀ",
										"rowId": `${prefix}makermenu`
									},
									{
										"title": "sᴏᴜɴᴅ ᴍᴇɴᴜ 🎵",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ sᴏᴜɴᴅ",
										"rowId": `${prefix}soundmenu`
									},
									{
										"title": "ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ ↘️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴅᴏᴡɴʟᴏᴀᴅ",
										"rowId": `${prefix}downloadmenu`
									},
									{
										"title": "sᴛɪᴄᴋᴇʀ ᴍᴇɴᴜ 🃏",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ sᴛɪᴄᴋᴇʀ",
										"rowId": `${prefix}stickermenu`
									},
									{
										"title": "sᴇᴀʀᴄʜɪɴɢ ᴍᴇɴᴜ🔍",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴊ sᴇᴀʀᴄʜɪɴɢ",
										"rowId": `${prefix}searchmenu`
									},
									{
										"title": "ᴛᴏᴏʟs ᴍᴇɴᴜ ⚙️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴛᴏᴏʟs",
										"rowId": `${prefix}toolmenu`
									},
									{
										"title": "ʀᴀɴᴅᴏᴍ ɪᴍᴀɢᴇ 🌆",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ɪᴍᴀɢᴇ ʀᴀɴᴅᴏᴍ",
										"rowId": `${prefix}randomimagemenu`
									},
										{
											"title": "ᴀɴɪᴍᴇ ᴍᴇɴᴜ🉐",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴀɴɪᴍᴇ",
										"rowId": `${prefix}animemenu`
										},
										{
										"title": "sᴛɪᴄᴋᴇʀ ᴀɴɪᴍᴇ🈷️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ sᴛɪᴄᴋᴇʀ ᴀɴɪᴍᴇ",
										"rowId": `${prefix}animestickermenu`
									     },
									{
										"title": "ɴsғᴡ ᴍᴇɴᴜ 🤓",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ɴsғᴡ",
										"rowId": `${prefix}nsfwmenu`
									     },
										{
											"title": "ғᴜɴ ᴍᴇɴᴜ🕺",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ғᴜɴ",
										"rowId": `${prefix}funmenu`
										},
										{
										"title": "ɢᴀᴍᴇ ᴍᴇɴᴜ 🎮",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ɢᴀᴍᴇ",
										"rowId": `${prefix}gamemenu`
									},
										{
											"title": "ᴄᴏɴᴠᴇʀᴛ ᴍᴇɴᴜ ⚒️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴄᴏɴᴠᴇʀᴛ",
										"rowId": `${prefix}convertmenu`
										},
										{
											"title": "ᴅᴀᴛᴀʙᴀsᴇ ᴍᴇɴᴜ ♻️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴅᴀᴛᴀʙᴀsᴇ",
										"rowId": `${prefix}databasemenu`
										},
										{
											"title": "ɪsʟᴀᴍɪᴄ ᴍᴇɴᴜ 🧕",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ɪsʟᴀᴍɪᴄ",
										"rowId": `${prefix}islamicmenu`
										},
										{
										"title": "ɴᴇᴡs ᴍᴇɴᴜ  🦜",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ɴᴇᴡs",
										"rowId": `${prefix}indomenu`
									},
										{
											"title": "ʜᴏʀᴏsᴄᴏᴘᴇ ᴍᴇɴᴜ 🕊️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ʜᴏʀᴏsᴄᴏᴘᴇ",
										"rowId": `${prefix}indohoroscopemenu`
										}
								]
							},
							{
								"title": "ᴀɴᴏɴʏᴍᴏᴜs ᴍᴇɴᴜ🕵️",
								"rows": [
									{
										"title": "ᴀɴᴏɴʏᴍᴏᴜs ᴄʜᴀᴛ ᴍᴇɴᴜ 🙎🏻‍♂️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀɴ ᴍᴇɴᴜ ᴀɴᴏɴʏᴍᴏᴜs",
							...
							},
							{
								...
								"rows": [
									{
										"title": "ᴛʜᴀɴᴋs ᴛᴏ ❤️",
										"description": "ᴛᴀᴍᴘɪʟᴋᴀᴍ ᴛʜᴀɴᴋs ᴛᴏ !!",
										"rowId": `${prefix}tqtt`
									}
								]
							}
...
╠➪ ${prefix}request
╠➪ ${prefix}report [bug]
╚════════════❏` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "ᴡᴇʙsɪᴛᴇ 📨","url": `${websitex}`}},{"urlButton": {"displayText": "sᴄʀɪᴘᴛ 🗂️","url": `${botscript}`}},{"quickReplyButton": {"displayText": "ᴅᴏɴᴀsɪ 📚","id": 'donate'}},{"quickReplyButton": {"displayText": "ᴏᴡɴᴇʀ 👤","id": 'owner'}}] )
break
case 'ownermenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
